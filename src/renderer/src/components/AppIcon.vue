...
const ICONS: Record<string, IconDef> = {
  ...
  heartbeat: {
    inner:
      '<path d="M3 12h4l2.1-5.3L13 18l2.2-6H21"/><path d="M12 21.5 4.6 14a4.6 4.6 0 0 1 6.5-6.5l.9.9.9-.9a4.6 4.6 0 0 1 6.5 6.5z"/>'
  },
  'heart-mode': {
    inner:
      '<path d="M12 20.4 4.8 13a4.5 4.5 0 0 1 6.3-6.4l.9.9.9-.9a4.5 4.5 0 0 1 6.3 6.4z"/><path d="M12 9.8v5.6M9.2 12.6h5.6"/>'
  },
  'daily-recommendation': {
    inner:
      '<rect x="4" y="5" width="16" height="15" rx="3"/><path d="M8 3v4M16 3v4M4 10h16"/><path d="m12 13 .8 1.8 1.9.2-1.4 1.3.4 1.9-1.7-1-1.7 1 .4-1.9-1.4-1.3 1.9-.2z"/>'
  },
  more: {
    inner:
