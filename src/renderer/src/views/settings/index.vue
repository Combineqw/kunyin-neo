...
import SettingRecommendation from './SettingRecommendation.vue'
...
const tocList = [
  ...
  { id: 'SettingAnimation', title: '动效实验室', icon: 'heartbeat' },
  { id: 'SettingPlay', title: '播放', icon: 'play' },
  { id: 'SettingRecommendation', title: '个性化推荐', icon: 'heart-mode' },
